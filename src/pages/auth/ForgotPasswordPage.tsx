  ...
  return (
    <main className="dark relative flex min-h-screen items-center justify-center overflow-hidden bg-[#020202] px-4 py-12 text-white sm:px-6">
      ...
      <section className="relative z-10 grid w-full max-w-5xl overflow-hidden rounded-3xl border border-[#D4AF37]/20 bg-[#090907]/90 shadow-2xl shadow-black/50 backdrop-blur-xl lg:grid-cols-[1.05fr_0.95fr]">
        <div className="hidden min-h-[680px] flex-col justify-between border-r border-[#D4AF37]/15 bg-gradient-to-br from-[#2A2107]/90 via-[#0D0A03] to-[#020202] p-12 lg:flex">
          <Link
            to="/"
              ...
              <>
                ...
                >
                  <div>
                    ...
                    <input
                      ...
                      disabled={isSubmitting}
                      className="h-12 w-full rounded-xl border border-[#D4AF37]/20 bg-black/40 px-4 text-center font-mono text-lg tracking-[0.45em] text-white outline-none transition placeholder:text-white/20 focus:border-[#D4AF37]/80 focus:ring-4 focus:ring-[#D4AF37]/15 disabled:opacity-60"
                    />
                  </div>
                ...
                <div className="mt-6 flex items-center justify-between gap-4">
                  ...
                  <button
                    ...
                    disabled={isSubmitting}
                    className="text-sm font-medium text-[#E8C75A] transition hover:text-[#F4D06F] disabled:opacity-50"
                  >
                    Resend code
                  </button>
                </div>
