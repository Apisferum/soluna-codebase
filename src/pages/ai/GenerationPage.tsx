...
} from "@/services/api/generationApi";
...
export default function GenerationPage() {
  ...
  return (
    <div className="dark relative min-h-screen overflow-hidden bg-[#030303] selection:bg-[#D4AF37]/25">
      <main className="container relative z-10 mx-auto px-4 pb-16 pt-8 md:px-6 md:pt-12">
        <div className="mx-auto max-w-5xl">
          <div className="mb-6 flex items-center justify-between gap-4">
            ...
            <div className="flex shrink-0 items-center gap-2">
              <Button
                ...
                type="button"
                variant="outline"
                className="rounded-xl border-[#D4AF37]/35 bg-[#D4AF37]/10 text-[#F4D06F] hover:border-[#D4AF37]/60 hover:bg-[#D4AF37]/20 hover:text-[#FFE59A]"
              >
                <Link to="/history">
              ...
              <Button
                ...
                className="rounded-xl border-[#D4AF37]/20 bg-white/[0.03] text-white hover:bg-white/10"
              >
                Log out
              </Button>
            </div>
          ...
          <div className="mb-16 space-y-6 text-center">
            <div className="inline-flex items-center space-x-2 rounded-full border border-[#D4AF37]/15 bg-white/[0.02] px-3 py-1 text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground">
          ...
          <div className="glass-card flex min-h-[550px] flex-col justify-center overflow-hidden rounded-[2.5rem] border border-[#D4AF37]/15 bg-[#0a0a0a]/90 p-10 shadow-2xl">
            {!prompt && (
              ...
              <AnimatePresence mode="wait">
                {isGenerating && (
                  ...
                  >
                    <div className="flex flex-col items-center justify-center space-y-4">
                      <div className="relative flex h-24 w-24 items-center justify-center rounded-full border border-[#D4AF37]/15 bg-white/[0.03]">
                      ...
                      <div className="max-w-md space-y-2 text-center">
                        ...
                        <div className="truncate rounded-xl border border-[#D4AF37]/15 bg-white/[0.02] p-3 px-4 text-xs italic leading-relaxed text-muted-foreground">
                          “{prompt}”
                        </div>
                      </div>
                    </div>

                    <div className="mx-auto w-full max-w-md space-y-3 rounded-2xl border border-[#D4AF37]/15 bg-white/[0.02] p-6 text-left font-mono text-xs">
                ...
                {isCompleted &&
                  ...
                  generationResult && (
                    ...
                    >
                      <div className="relative flex flex-col gap-3 overflow-hidden rounded-2xl border border-[#D4AF37]/15 bg-white/[0.02] p-6">
                        <div className="flex flex-wrap items-center justify-between gap-3">
                          ...
                          <span className="rounded-full border border-[#D4AF37]/30 bg-[#D4AF37]/10 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.15em] text-[#F4D06F]">
                            {
                      ...
                      <div className="space-y-4">
                        <Button
                          onClick={togglePlay}
                          className="h-16 w-full rounded-2xl bg-gradient-to-r from-[#A87912] via-[#D4AF37] to-[#F1D36A] text-lg font-semibold text-black shadow-lg shadow-[#D4AF37]/15 hover:brightness-110"
                        >
                          {isPlaying
                            ? "⏸ Pause Audio"
                            : isReferenceAudio
                        ...
                        {isReferenceAudio && (
                          <p className="text-center text-xs text-[#E8C75A]/80">
                            The backend did not
                            provide a playable
                        ...
                        <div className="grid gap-6 pt-4 md:grid-cols-2">
                          <div className="space-y-4 rounded-2xl border border-[#D4AF37]/15 bg-white/[0.02] p-6">
                            <div className="flex items-center gap-3">
                              <div className="rounded-xl border border-[#D4AF37]/15 bg-white/5 p-2">
                            ...
                            {generatedAudioPath ? (
                              <button
                                ...
                                className="flex h-10 w-full items-center justify-center gap-2 rounded-lg border border-[#D4AF37]/20 bg-white/5 px-4 text-xs font-semibold text-white transition-all hover:border-[#D4AF37]/40"
                              >
                          ...
                          <div className="flex flex-col justify-between space-y-4 rounded-2xl border border-[#D4AF37]/15 bg-white/[0.02] p-6">
                            <div className="space-y-4">
                              <div className="flex items-center gap-3">
                                <div className="rounded-xl border border-[#D4AF37]/15 bg-white/5 p-2">
                        ...
                        <div className="mt-6 flex items-center justify-between border-t border-[#D4AF37]/15 pt-6">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <Button
                              ...
                              variant="ghost"
                              className="h-9 rounded-lg border border-[#D4AF37]/20 text-xs text-muted-foreground hover:bg-white/5 hover:text-white"
                            >
