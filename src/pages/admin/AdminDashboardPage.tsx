...
const LOSS_SERIES: ChartSeriesItem[] = [
  { key: "trainLoss", label: "Train loss", color: "#f4d06f" },
  { key: "evalLoss", label: "Evaluation loss", color: "#d4af37" },
  { key: "bestEvalLoss", label: "Best evaluation loss", color: "#a87912" },
];

const PERPLEXITY_SERIES: ChartSeriesItem[] = [
  { key: "trainPerplexity", label: "Train perplexity", color: "#fff1b8" },
  { key: "evalPerplexity", label: "Evaluation perplexity", color: "#c7951c" },
  {
