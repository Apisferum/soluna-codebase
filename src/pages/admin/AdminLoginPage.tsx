    ...
    return (
      <main className="dark flex min-h-screen items-center justify-center bg-[#020202] px-6 text-white">
        <div className="text-center">
          <div className="mx-auto mb-5 h-10 w-10 animate-spin rounded-full border-2 border-white/20 border-t-[#D4AF37]" />
  ...
  return (
    <main className="dark relative flex min-h-screen items-center justify-center overflow-hidden bg-[#020202] px-4 py-12 text-white sm:px-6">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute left-[-9rem] top-[-8rem] h-96 w-96 rounded-full bg-[#D4AF37]/20 blur-[140px]" />

        <div className="absolute bottom-[-10rem] right-[-7rem] h-96 w-96 rounded-full bg-[#8A6A16]/18 blur-[150px]" />

        <div className="absolute left-1/2 top-1/2 h-80 w-80 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#F4D06F]/10 blur-[150px]" />
      </div>

      <section className="relative z-10 grid w-full max-w-5xl overflow-hidden rounded-3xl border border-[#D4AF37]/20 bg-[#090907]/90 shadow-2xl shadow-black/50 backdrop-blur-xl lg:grid-cols-[1.05fr_0.95fr]">
        <div className="hidden min-h-[650px] flex-col justify-between border-r border-[#D4AF37]/15 bg-gradient-to-br from-[#2A2107]/90 via-[#0D0A03] to-[#020202] p-12 lg:flex">
          <Link
            to="/"
            ...
            >
              <div>
                ...
                <input
                  ...
                  className="h-12 w-full rounded-xl border border-[#D4AF37]/20 bg-black/40 px-4 text-sm text-white outline-none transition placeholder:text-white/30 focus:border-[#D4AF37]/80 focus:ring-4 focus:ring-[#D4AF37]/15 disabled:cursor-not-allowed disabled:opacity-60"
                />
              </div>
