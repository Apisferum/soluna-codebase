...
import Fretboard3DWrapper from "@/components/music/fretboard/Fretboard3DWrapper";
import type { FretNote } from "@/components/music/fretboard/Fretboard3D";
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden selection:bg-white/10">
      <main className="container mx-auto px-4 md:px-6 pt-8 md:pt-12 pb-16 relative z-10">
        <Breadcrumb items={[
          { name: "Home", url: "https://SoLuna.studio/", forceRefresh: true },
