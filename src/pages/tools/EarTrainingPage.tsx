...
import { IntervalGame } from "@/components/music/ear-training/IntervalGame";
...
<motion.div
    ...
    whileTap={{ scale: 0.98 }}
    /* Added mx-auto for horizontal centering, max-w for a clean card width, and w-full */
    className="group relative cursor-pointer mx-auto w-full max-w-md"
    onClick={onClick}
>
    <div className={cn(
