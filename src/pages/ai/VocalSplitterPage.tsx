...
import { STEMS_API_BASE, resolveAbsoluteUrl } from "@/services/api/config";
...
const VocalSplitterPage = () => {
  ...
  const processSeparation = async () => {
    ...
    try {
      ...
      const apiUrl = STEMS_API_BASE;
      const endpoint = `${apiUrl}/separate`;
      ...
      const vocalsAbs = resolveAbsoluteUrl(result.vocalsUrl, STEMS_API_BASE);
      const instrumentalAbs = resolveAbsoluteUrl(result.instrumentalUrl, STEMS_API_BASE);
